                        ...
                        <td class="table__td">
                            ...
                            <?php if($pedido->estado_id == 1) { ?>    
                                ...
                                <form method="POST">
                                    ...
                                    <div class="table__td--estado">
                                        <input type="hidden" name="id" value="<?php echo $pedido->id ?>">
                                        <input class="table__td--estado-color" type="submit" value="Confirmar">
                                    </div>
                        ...
                        <td class="table__td">
                            <?php
                                ...
                                if($_SESSION['fabrica'] == 1 || $_SESSION['rol'] == 1 && str_contains($_SERVER['PATH_INFO'] ?? '/', '/fabrica-1')) { ?>
                                    <a class="table__td--boton" href="/fabrica-1/pedidos/informacion?id=<?php echo $pedido->id ?>">Ver Más</a>
                                <?php }

                                if($_SESSION['fabrica'] == 2 || $_SESSION['rol'] == 1 && str_contains($_SERVER['PATH_INFO'] ?? '/', '/fabrica-2')) { ?>
                                    <a class="table__td--boton" href="/fabrica-2/pedidos/informacion?id=<?php echo $pedido->id ?>">Ver Más</a>
                                <?php }
                            ?>
                        </td>
                    </tr>
